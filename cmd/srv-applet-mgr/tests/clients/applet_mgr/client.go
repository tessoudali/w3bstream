...
type Interface interface {
	...
	CreateAccountAccessKey(req *CreateAccountAccessKey, metas ...kit.Metadata) (*GithubComMachinefiW3BstreamPkgModulesAccountAccessCreateRsp, kit.Metadata, error)
...
func (c *Client) CreateAccountAccessKey(req *CreateAccountAccessKey, metas ...kit.Metadata) (*GithubComMachinefiW3BstreamPkgModulesAccountAccessCreateRsp, kit.Metadata, error) {
	return req.InvokeContext(c.Context(), c.Client, metas...)
}
